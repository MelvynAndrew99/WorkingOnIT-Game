...
const out='/tmp/oneway-ring-pacing';mkdirSync(out,{recursive:true});
const raw=JSON.parse(readFileSync('/home/phil/Code/jams/AI-Overlord/docs/transit-and-one-way/verification/player-ring-save.json','utf8'));
...
const results=[];
try{for(const width of [1440,390])for(const [label,port]of [['ring',5217]]) {
