...
const out='/tmp/oneway-pacing';mkdirSync(out,{recursive:true});
const raw=JSON.parse(readFileSync('/home/phil/Code/jams/AI-Overlord/docs/performance-review/player-town/save.json','utf8'));
...
const results=[];
try{for(const width of [1440,390])for(const [label,port]of [['baseline',5218],['oneway',5217]]) {
