...
9. Open Add land and expand twice. The first two strips are free; the manager then explains the mayor's mission funding requirement. Completion offers City link; player explicitly connects to a boundary road when ready. Further growth missions award saved land permits. See [land progression](../land-progression/README.md).
