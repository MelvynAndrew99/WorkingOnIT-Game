/**
 * Cut named frames out of apartment-sheet.png and write zoom.png at 6x for close inspection.
 *   node docs/artwork/housing/residential-apartment/zoom.mjs apartment_1_S apartment_2_S_N_0
...
const wanted = keys.length ? keys : ['apartment_1_S', 'apartment_2_S_S_3'];
