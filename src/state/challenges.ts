...
export function selectChallenge(id:ChallengeId){
  ...
  selected=id;
  if(runs[id]&&((id==='neighborhood-roads'&&runs[id]!.revision!==2)||(id==='a-town-that-works'&&runs[id]!.revision!==3)||(id==='past-the-wreck'&&runs[id]!.revision!==5)||(id==='temporary-two-way'&&runs[id]!.revision!==4)||(id==='another-front-door'&&runs[id]!.revision!==3))){stars[id]=challengeHasStar(id);archivedRuns[id]=runs[id];runs[id]=createChallenge(id);flushChallenges();}
